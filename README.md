...
Set up an HTML skeleton inside of src/template.html. 
...
Next, set up your restaurant site to use tabbed browsing to access the Menu and Contact pages. 

Look at the behavior of this student’s live preview site for visual inspiration.
...
You should have event listeners for each button in the header navbar that wipes out the current contents of div#content and then runs the correct ‘tab module’ to populate it with the new contents again.


![Restaurant Page](https://github.com/user-attachments/assets/b01729bc-67ad-449d-8f76-58f10d914af3)
